package thisisjava.chap16_stream.sec12._parallelism;
...
public class ArrayListVsLinkedListExample {
    ...
    public static void main(String... args) {
        ...
        if(arrayListListParallel < linkedListParallel) {
            ...
            System.out.println("(linkedListParallel-arrayListListParallel) = " + (linkedListParallel-arrayListListParallel));
        } else {
            System.out.println("성능 테스트 결과: LinkedList 처리가 더빠름");
            System.out.println("arrayListListParallel = " + arrayListListParallel);
            System.out.println("linkedListParallel = " + linkedListParallel);
            System.out.println("(arrayListListParallel-linkedListParallel) = " + (arrayListListParallel-linkedListParallel));
        }
    }
}
